(function(){
	...
	var XMLTransform = my.Class({
		...
		constructor: function(element,params){
				...
				this.pathToXML= false,
				this.pathToXSL= false,	
				this.passQueryParams= false,
				this.pars=params,
				this.transform=true,
				this.el= element
		...
		//netscape.security.PrivilegeManager.enablePrivilege("UniversalBrowserRead");
				...
				$(this.el).innerHTML=xml.transformNode(xsl);
	...
	namespace.XMLTransform = XMLTransform;
})();